...
def circle(car):
    ...
    # 1- complete circular track with a low angle and a specific speed
    car.gas(0.5)
    time.sleep(1.5)
    car.steer(5)
    
    # 2- Go forward for a while, then steer right for a while
    '''''''''
    steer=0
    k=1
    while (k==1):
